...
public class DataAdapter extends ArrayAdapter<NewBook> {

    private static final String LOG_TAG = DataAdapter.class.getSimpleName();

    public DataAdapter(Activity context, ArrayList<NewBook> Books) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final NewBook currentBook = getItem(position);
