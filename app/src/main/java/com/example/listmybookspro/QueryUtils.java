...
public final class QueryUtils {
    ...
    /**
     * Return an {@link NewBook} object by parsing out information
     * about the first book from the input bookJSON string.
     */
    private static List<NewBook> extractBookFromJson(String bookJSON) {
    ...
    /**
     * Query the USGS dataset and return a list of {@link NewBook} objects.
     */
    static List<NewBook> fetchBookData(String requestUrl) {
        ...
        List<NewBook> listBooks = extractBookFromJson(jsonResponse);
