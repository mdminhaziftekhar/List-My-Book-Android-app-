...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<NewBook>> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new DataAdapter(this, new ArrayList<NewBook>());
...

        {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                NewBook currentBook = mAdapter.getItem(position);
    ...
    @Override
    public Loader<List<NewBook>> onCreateLoader(int i, Bundle bundle) {
...
//    }
    ...
    @Override
    public void onLoadFinished(Loader<List<NewBook>> loader, List<NewBook> books) {
    ...
    @Override
    public void onLoaderReset(Loader<List<NewBook>> loader) {
